...
function Sidebar() {
  ...
  return (
    <div style={{
      ...
      background: 'rgba(29,26,57,0.9)', backdropFilter: 'blur(16px)',
      ...
      <div
        ...
        style={{
          ...
          background: location.pathname === '/myprofile'
            ? 'linear-gradient(135deg, rgba(243,159,90,0.18), rgba(174,68,90,0.18))'
