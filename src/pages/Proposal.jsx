...
Looking forward to hearing from you!`)
  ...
  const tabStyle = (tab) => ({
    ...
    background: activeTab === tab
      ? 'linear-gradient(135deg, rgba(243,159,90,0.25), rgba(174,68,90,0.25))'
      : 'transparent',
    ...
    <div style={{ minHeight: '100vh', padding: '40px 24px' }}>
      <div style={{ maxWidth: '580px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#E8BCB9', opacity: 0.7, marginBottom: '28px' }}>
          Paste a job description and get a personalized AI proposal
        </p>
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {/* Profile Tabs */}
          <div>
            <label style={{ fontSize: '13px', fontWeight: 600, color: '#E8BCB9', display: 'block', marginBottom: '10px' }}>
              About You
            </label>
            <div style={{
              ...
              <button onClick={() => setActiveTab('extra')} style={tabStyle('extra')}>
          ...
          <div className="card" style={{ marginTop: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <span style={{
                ...
                background: 'rgba(243,159,90,0.15)', color: '#F39F5A',
                border: '1px solid rgba(243,159,90,0.3)', textTransform: 'capitalize'
              }}>
                {tone} tone
              </span>
            </div>
            <p style={{ color: '#E8BCB9', lineHeight: 1.8, whiteSpace: 'pre-line', fontSize: '15px' }}>
              {proposal}
            </p>
            <button
              ...
              style={{
                ...
                border: '2px solid rgba(243,159,90,0.4)', color: '#F39F5A',
